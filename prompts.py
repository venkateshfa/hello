...
You are a financial analyst. Your task is to read the disclosure below and determine whether the company has entered into a financing arrangement relating to its account receivables, and provide information about the quantification of that arrangement. Such financing arrangements may be described as “factoring” or “securitization” of receivables. 

1.  In the most recent financial year, did the company have a receivable financing arrangement (answer “YES” or “NO” only)

2. Did this arrangement result in the company selling or derecognising the receivables from the balance sheet (i.e. was it a true sale from an accounting perspective)? (answer “YES” or “NO” only)

3. Does the company quantify:
The value of receivables sold/ derecognized over a period of time? Note this is a “flow” figure - i.e. measured over a period of time.
The value of receivables subject to the arrangement which are outstanding/ uncollected at the end of the period? Note this is a “stock” figure - i.e. measured as at a point in time (the balance sheet date). Disclosure that states that receivables outstanding were “insignificant” or “immaterial” or that there were no receivables outstanding should be accepted as quantification.
Both a and b  (note the same value cannot be used as both a “flow” and “stock” value.)
